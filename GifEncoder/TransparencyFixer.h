...
private:
	...
	winrt::com_ptr<ID3D11Texture2D> m_previousIndexTexture;
	winrt::com_ptr<ID3D11Texture2D> m_previousIndexStagingTexture;
	winrt::com_ptr<ID3D11ShaderResourceView> m_previousSrv;
	winrt::com_ptr<ID3D11ShaderResourceView> m_previousIndexSrv;
